...
export const heroBoardFields: FieldDefinition[] = [
...
export const heroBoardRegistration: BlockRegistration = {
...
export const heroBoardDesigns: Array<{ name: string; slug: string; design: DesignPrimitive }> = [
