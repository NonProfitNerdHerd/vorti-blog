...
export type Template = { id: ID; slug: string; name: string; status: Lifecycle; allowedCollections: string[]; sections: TemplateSection[]; _status?: 'draft' | 'published' }
...
export type ResolvedContent = { contentId: ID; template: Template; sections: ResolvedSection[] }
